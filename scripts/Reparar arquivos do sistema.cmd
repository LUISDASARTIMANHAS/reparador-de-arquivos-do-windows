...
curl -X POST -H "Content-Type: application/json;charset=utf-8" -H "Authorization: snve072509&Aplication" -d "{\"usuario\": \"%USERNAME%\"}" https://pingobras-sg.glitch.me/global/database/1
